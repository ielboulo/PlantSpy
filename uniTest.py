...
# test d'une prédiction du modèle
    ...
    def test_image_prediction(self):
        ...
        with open(test_images[0], 'rb') as file:
            ...
            self.assertEqual(str(prediction_0["categorie"][0]), "Appleeee",
    ...
    def test_image_prediction_2(self):
        expected_categories = ["Appleee", "Appleeee", "Appleeee", "Appleeee", "Corneee", "Corneee", "Corn", "Potato", "Potato", "Potato", "Potato", "Tomato", "Tomato", "Tomato", "Tomato"]
